...
An agent skill for [Vine](https://vine.getcourtyard.ai), the API that live-detects the
customer-facing software (OpenTable, Mindbody, Toast, Calendly, and more) behind a business and the exact URL where an agent can act.
